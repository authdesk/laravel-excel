    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <a href="{{route('admin.settings.index')}}" ><i class="fa fa-diamond"></i> <span class="nav-label">Settings</span></a>
                </li>

                <li class="{{Route::is('admin.product*') ? 'active' : ''}}">
                <a href="{{route('admin.product.index')}}" ><i class="fa fa-shopping-cart"></i> <span class="nav-label">Product</span></a>
                </li>
