...
<div class="row wrapper border-bottom white-bg page-heading animated fadeInRight">
    ...
    <div class="col-lg-6 align-self-center ">
        <div class="my-auto">
        <a href="{{route('admin.product-import')}}" class="btn btn-primary btn-md float-right"> {{__('Import Products')}}</a>
    ...
    <div class="row">
        ...
        <div class="ibox ">
            ...
            <tr class="gradeX">
                ...
                @if($product->status ==1)
                    <label class="switch">
                        <input type="checkbox" checked value="{{URL::to('/admin/inactive-product/'.$product->id)}}">
                        <span class="slider round"></span>
                    </label>
                @else
                    <label class="switch">
                        <input type="checkbox" value="{{URL::to('/admin/active-product/'.$product->id)}}">
                        <span class="slider round"></span>
                    </label>
                @endif
