            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <dl class="row">
                            ...
                            <dt class="col-sm-3" >{{__('Product Processor')}} <span class="float-right">:</span></dt>
                            <dd class="col-sm-9">{{$product->product_processor}}</dd>
                            <dt class="col-sm-3" >{{__('Product Ram')}} <span class="float-right">:</span></dt>
                            <dd class="col-sm-9">{{$product->product_ram}}</dd>
                            <dt class="col-sm-3" >{{__('Product Storage')}} <span class="float-right">:</span></dt>
                            <dd class="col-sm-9">{{$product->product_storage}}</dd>
                            <dt class="col-sm-3" >{{__('Product Screen')}} <span class="float-right">:</span></dt>
                            <dd class="col-sm-9">{{$product->product_screen}}</dd>
